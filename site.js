(function () {
  ...
  } else syncGroups.forEach(activateGroup);
  ...
  document.querySelectorAll("[data-visualization-switch]").forEach(function (switcher) {
    ...
    function select(key) {
      ...
      panels.forEach(function (panel) { panel.hidden = panel.getAttribute("data-visualization-panel") !== key; });
    }
    buttons.forEach(function (button) {
      button.addEventListener("click", function () { select(button.getAttribute("data-visualization")); });
    });
